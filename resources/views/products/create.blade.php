...
@section('content')
    ...
    <div class="text-center text-white font-bold">Create new product</div>
        ...
        <div class="flex gap-4">
            ...
            <input name="code" class="form-control mt-1 block w-1/2 rounded-md border border-slate-300 bg-white px-3 py-4 sm:text-sm placeholder-purple" placeholder="Product Code" value="{{ old('product_code') }}" />
